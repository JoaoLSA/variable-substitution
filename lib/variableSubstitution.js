...
const coreFacade_1 = require("./operations/coreFacade");
const fs = require("fs");
        ...
        for (let file of files) {
            ...
            for (let file of matchedFiles) {
                ...
                if (this.isJson(file, fileContent)) {
                    ...
                    let shouldFailWhenValueIsMissing = coreFacade_1.getShouldFailWhenValueIsMissing();
                    let isJsonSubstitutionApplied = jsonSubsitution.substituteJsonVariable(jsonObject, envVariableUtility_1.EnvTreeUtility.getEnvVarTree(), shouldFailWhenValueIsMissing);
